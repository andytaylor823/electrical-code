...
def main():
    ...
    for i in range(len(paragraphs)):
        ...
        if in_def:
            definitions, current_section, skip_mode = handle_line(
                line, starts_new_section_def, definitions, current_section, skip_mode
            )
        elif in_main:
            sections, current_section, skip_mode = handle_line(
                line, starts_new_section_main, sections, current_section, skip_mode
            )
        else:
